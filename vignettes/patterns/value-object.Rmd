...
1.  Calling **Value Object** can happen inside one or more Domain Objects, such
    as Domain Entity, or another Value Object.

2.  Reusing **Value Object** in tests, such as unit-tests and integration-tests,
    is useful when the test aims to capture the structure of a returning object.
    
The following example shows how to embed the `Customer` **Value Object** in the pizza `Order` Entity
