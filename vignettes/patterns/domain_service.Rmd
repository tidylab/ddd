---
title: "The Domain Service Pattern"
...
-   Domain Service is part of the domain model. That means it expresses
    Ubiquitous Language in its Bounded Context.
...
Make sure you need a service. Stripping away behaviors that belong to Entity
overzealously, lead to Anemic Domain Model, where Entities comprise data but not
behavior. This is similar to representing an Entity with only a
